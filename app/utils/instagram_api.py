...
def send_dm(recipient_id: str, message: str, page_access_token: str, page_id: str = None) -> dict:
    ...
    Args:
        ...
        page_access_token: The Facebook Page or Instagram Business Account access token
        page_id: Optional Facebook Page ID. If not provided, uses me/messages endpoint
