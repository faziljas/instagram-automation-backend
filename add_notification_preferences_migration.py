...
Uses ADD COLUMN IF NOT EXISTS so it does not affect existing code or fail on re-run.
Ensures columns exist even if Alembic 013/015 did not run. Aligns with app/main.py startup check.
"""
